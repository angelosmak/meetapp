...
Event.create!(
  title: "Beach Party",
  datetime: DateTime.new(2023, 8, 15, 16, 0, 0),
  description: "Celebrate summer with a beach party filled with music, dancing, and fun in the sun.",
  max_attend: 300,
  category: "outdoor",
  price_per: 20,
  user_id: User.all.sample.id,
...
Event.create!(
  ...
  datetime: DateTime.new(2023, 9, 10, 8, 0, 0),
  description: "Immerse yourself in a rejuvenating yoga retreat on the tranquil beaches of Crete.",
  max_attend: 20,
  category: "outdoor",
  price_per: 50,
  user_id: User.all.sample.id,
  address: "Elafonisi Beach, Chania, Greece"
)

Event.create!(
  title: "Beach Volleyball Tournament",
  datetime: DateTime.new(2023, 7, 25, 10, 0, 0),
  description: "Compete in a thrilling beach volleyball tournament with teams from all over Greece.",
  max_attend: 100,
  category: "outdoor",
  price_per: 10,
  user_id: User.all.sample.id,
...
Event.create!(
  ...
  datetime: DateTime.new(2023, 8, 5, 9, 0, 0),
  description: "Join us in preserving the beauty of our beaches by participating in a beach cleanup day.",
  max_attend: 50,
  category: "outdoor",
  price_per: 0,
  user_id: User.all.sample.id,
...
Event.create!(
  title: "Beach Barbecue Party",
  datetime: DateTime.new(2023, 8, 20, 17, 0, 0),
  description: "Enjoy a delicious beach barbecue party with grilled delicacies and refreshing drinks.",
  max_attend: 150,
  category: "outdoor",
  price_per: 25,
  user_id: User.all.sample.id,
  address: "Agios Prokopios , Naxos, Greece"
)

Event.create!(
  title: "Surfing Lessons",
  datetime: DateTime.new(2023, 9, 5, 11, 0, 0),
  description: "Learn how to ride the waves with professional surfing lessons on the beautiful beaches of Rhodes.",
  max_attend: 10,
  category: "outdoor",
  price_per: 80,
  user_id: User.all.sample.id,
  address: "Prasonisi Beach, Rhodes, Greece"
)

Event.create!(
  title: "Beachside Yoga Class",
  datetime: DateTime.new(2023, 7, 30, 8, 30, 0),
  description: "Start your day with a revitalizing yoga class overlooking the serene beaches of Corfu.",
  max_attend: 30,
  category: "outdoor",
  price_per: 15,
  user_id: User.all.sample.id,
...
Event.create!(
  title: "Beach Photography Workshop",
  datetime: DateTime.new(2023, 8, 10, 14, 0, 0),
  description: "Capture the beauty of the Greek beaches through a hands-on photography workshop.",
  max_attend: 20,
  category: "outdoor",
  price_per: 50,
  user_id: User.all.sample.id,
  address: "Balos Beach, Chania, Greece"
)

Event.create!(
  title: "Beachside Cocktail Making",
  datetime: DateTime.new(2023, 9, 15, 18, 0, 0),
  description: "Learn how to craft delicious cocktails while enjoying the stunning views of the Athens Riviera.",
  max_attend: 40,
  category: "outdoor",
  price_per: 30,
  user_id: User.all.sample.id,
...
Event.create!(
  title: "Beach Volleyball Workshop",
  datetime: DateTime.new(2023, 8, 25, 10, 0, 0),
  description: "Improve your beach volleyball skills with expert coaches in a comprehensive workshop.",
  max_attend: 30,
  category: "outdoor",
  price_per: 35,
  user_id: User.all.sample.id,
  address: "Golden Beach, Thassos, Greece"
)

# ...puts
puts "Seeds planted successfully water them and they will grow to be strong trees!"
